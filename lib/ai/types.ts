...
export interface AgentActionRecord {
  ...
  /** Deterministic per change-item so repeated execution can never duplicate. */
...
export const AI_LIMITS = {
  maxBodyBytes: 32_768,
  /** Hard transport cap applied before the body is parsed (413). */
  maxTransportBytes: 256 * 1024,
